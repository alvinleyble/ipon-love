 ...
 * partner's row has synced in, or while the invite is still unredeemed), plus the couple's
 * [coupleName] and optional premium [coupleBannerUrl] photo (both null until the couple row
 * replicates / no photo set). Emitted only while paired — see ObserveCoupleMembersUseCase.
 */
