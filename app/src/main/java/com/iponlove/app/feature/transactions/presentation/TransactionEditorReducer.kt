...
object TransactionEditorReducer {
    ...
    sealed interface BuildResult {
         ...
         * created (the "paid for partner" path); null means a plain transaction save.
         */
        data class Ready(val transaction: Transaction, val amountOwed: BigDecimal?) : BuildResult
    }
