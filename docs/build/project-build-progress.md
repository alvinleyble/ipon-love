...
| V1.6.1 | Feature-complete, pending commit approval — 12-item beta polish batch (navbar redesign + PIN/data-leak fix, forgot password, PIN lockout, Analysis presets, Records month-window, transfer fee, biometric fix, version gate, etc.) | [v1.6.1.md](v1.6.1.md) |
